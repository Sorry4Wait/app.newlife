...
export default [
  ...
  },
  {
    header: "Directory",
    icon: "PackageIcon",
    i18n: "directory.title",
    items: [
      {
        url: "/directory/ins-directory-calculation-type",
        name: "ins-directory-calculation-type",
        slug: "ins-directory-calculation-type",
        icon: "ListIcon",
        i18n: "directory.ins-directory-calculation-type.title",
      },
      {
        url: "/directory/ins-directory-product-type",
        name: "ins-directory-product-type",
        slug: "ins-directory-product-type",
        icon: "ListIcon",
        i18n: "directory.ins-directory-product-type.title",
      },
      {
        url: "/directory/ins-directory-product-kind",
        name: "ins-directory-product-kind",
        slug: "ins-directory-product-kind",
        icon: "ListIcon",
        i18n: "directory.ins-directory-product-kind.title",
      },
      {
        url: "/directory/ins-directory-prefix",
        name: "ins-directory-prefix",
        slug: "ins-directory-prefix",
        icon: "ListIcon",
        i18n: "directory.ins-directory-prefix.title",
      },
      {
        url: "/directory/ins-directory-departcodes",
        name: "ins-directory-departcodes",
        slug: "ins-directory-departcodes",
        icon: "ListIcon",
        i18n: "directory.ins-directory-departcodes.title",
      },
      {
        url: "/directory/ins-directory-appform",
        name: "ins-directory-appform",
        slug: "ins-directory-appform",
        icon: "ListIcon",
        i18n: "directory.ins-directory-appform.title",
      },
